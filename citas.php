        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                ...
                <form action="citas.php" method="POST" class="grid grid-cols-4 gap-4">
                    ...
                    <button type="submit" name="add_cita" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                        Agendar
                    </button>
                </form>
            </div>
                        ...
                        <?php foreach ($citas as $cita): ?>
                            <tr class="<?php echo $cita['estado'] == 'pendiente' ? 'bg-yellow-50' : 'bg-white'; ?>">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php echo date('d/m/Y H:i', strtotime($cita['fecha'])); ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
